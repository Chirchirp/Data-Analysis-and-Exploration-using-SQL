...
/*1. Delete table Employee, Department and Company from a databse*/
DROP TABLE IF EXISTS Employee;
DROP TABLE IF EXISTS Department;
DROP TABLE IF EXISTS Company;

/*2. Create tables whihc meets the conditions below:

a) Employee with attributes (id, name, city, department, salary)
b) Department with attributes (id, name)
c) Company with attributes (id, name, revenue)
*/
